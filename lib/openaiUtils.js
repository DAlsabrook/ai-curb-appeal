...
async function convertImageToBase64(imageURL) {
    ...
    const resizedImageBuffer = await sharp(imageBuffer)
        ...
        .jpeg({ quality: 95 }) // Adjust quality to reduce size
        .toBuffer();
